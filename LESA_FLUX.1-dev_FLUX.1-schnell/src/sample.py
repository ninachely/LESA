...
def main(opts: SamplingOptions):
    ...
    for _ in range(len(prompts)):
        ...
        fn = os.path.join(opts.output_dir, f"img_{start + idx}.jpg")
...
if __name__ == '__main__':
    ...
    main(opts)
    # PYTHONPATH=. CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 src/sample.py
